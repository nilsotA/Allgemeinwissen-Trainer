...
const NUR_FUER_DIE_WERKSTATT = new Set(['./data/kennungen.json', './data/quizprobe.json', './data/quizprobe2.json', './data/quizprobe3.json', './data/quizprobe4.json', './data/quizprobe5.json', './data/tippprobe.json']);
